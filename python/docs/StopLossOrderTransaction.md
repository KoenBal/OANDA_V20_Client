...
**type** | **str** | The Type of the Transaction. Always set to \&quot;STOP_LOSS_ORDER\&quot; in a StopLossOrderTransaction. | [optional] 
...
**guaranteed_execution_premium** | **str** | The fee that will be charged if the Stop Loss Order is guaranteed and the Order is filled at the guaranteed price. The value is determined at Order creation time. It is in price units and is charged for each unit of the Trade. | [optional] 
