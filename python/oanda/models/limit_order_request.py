...
class LimitOrderRequest(object):
    ...
    def __init__(self, type=None, instrument=None, units=None, price=None, time_in_force=None, gtd_time=None, position_fill=None, trigger_condition=None, client_extensions=None, take_profit_on_fill=None, stop_loss_on_fill=None, trailing_stop_loss_on_fill=None, trade_client_extensions=None):  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this LimitOrderRequest.  # noqa: E501

        The type of the Order to Create. Must be set to \"LIMIT\" when creating a Market Order.  # noqa: E501

        :return: The type of this LimitOrderRequest.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this LimitOrderRequest.

        The type of the Order to Create. Must be set to \"LIMIT\" when creating a Market Order.  # noqa: E501

        :param type: The type of this LimitOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def instrument(self):
        """Gets the instrument of this LimitOrderRequest.  # noqa: E501

        The Limit Order's Instrument.  # noqa: E501

        :return: The instrument of this LimitOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument(self, instrument):
        """Sets the instrument of this LimitOrderRequest.

        The Limit Order's Instrument.  # noqa: E501

        :param instrument: The instrument of this LimitOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def units(self):
        """Gets the units of this LimitOrderRequest.  # noqa: E501
        ...
        :return: The units of this LimitOrderRequest.  # noqa: E501
        :rtype: str
        """
        return self._units
    ...
    def units(self, units):
        """Sets the units of this LimitOrderRequest.

        The quantity requested to be filled by the Limit Order. A posititive number of units results in a long Order, and a negative number of units results in a short Order.  # noqa: E501

        :param units: The units of this LimitOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def time_in_force(self):
        """Gets the time_in_force of this LimitOrderRequest.  # noqa: E501

        The time-in-force requested for the Limit Order.  # noqa: E501

        :return: The time_in_force of this LimitOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def time_in_force(self, time_in_force):
        """Sets the time_in_force of this LimitOrderRequest.

        The time-in-force requested for the Limit Order.  # noqa: E501

        :param time_in_force: The time_in_force of this LimitOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def gtd_time(self):
        """Gets the gtd_time of this LimitOrderRequest.  # noqa: E501

        The date/time when the Limit Order will be cancelled if its timeInForce is \"GTD\".  # noqa: E501

        :return: The gtd_time of this LimitOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def gtd_time(self, gtd_time):
        """Sets the gtd_time of this LimitOrderRequest.

        The date/time when the Limit Order will be cancelled if its timeInForce is \"GTD\".  # noqa: E501

        :param gtd_time: The gtd_time of this LimitOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def position_fill(self):
        """Gets the position_fill of this LimitOrderRequest.  # noqa: E501

        Specification of how Positions in the Account are modified when the Order is filled.  # noqa: E501

        :return: The position_fill of this LimitOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def position_fill(self, position_fill):
        """Sets the position_fill of this LimitOrderRequest.

        Specification of how Positions in the Account are modified when the Order is filled.  # noqa: E501

        :param position_fill: The position_fill of this LimitOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def trigger_condition(self):
        """Gets the trigger_condition of this LimitOrderRequest.  # noqa: E501
        ...
        :return: The trigger_condition of this LimitOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def trigger_condition(self, trigger_condition):
        """Sets the trigger_condition of this LimitOrderRequest.

        Specification of which price component should be used when determining if an Order should be triggered and filled. This allows Orders to be triggered based on the bid, ask, mid, default (ask for buy, bid for sell) or inverse (ask for sell, bid for buy) price depending on the desired behaviour. Orders are always filled using their default price component. This feature is only provided through the REST API. Clients who choose to specify a non-default trigger condition will not see it reflected in any of OANDA's proprietary or partner trading platforms, their transaction history or their account statements. OANDA platforms always assume that an Order's trigger condition is set to the default value when indicating the distance from an Order's trigger price, and will always provide the default trigger condition when creating or modifying an Order. A special restriction applies when creating a guaranteed Stop Loss Order. In this case the TriggerCondition value must either be \"DEFAULT\", or the \"natural\" trigger side \"DEFAULT\" results in. So for a Stop Loss Order for a long trade valid values are \"DEFAULT\" and \"BID\", and for short trades \"DEFAULT\" and \"ASK\" are valid.  # noqa: E501

        :param trigger_condition: The trigger_condition of this LimitOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def client_extensions(self):
        """Gets the client_extensions of this LimitOrderRequest.  # noqa: E501


        :return: The client_extensions of this LimitOrderRequest.  # noqa: E501
    ...
    def client_extensions(self, client_extensions):
        """Sets the client_extensions of this LimitOrderRequest.


        :param client_extensions: The client_extensions of this LimitOrderRequest.  # noqa: E501
    ...
    def take_profit_on_fill(self):
        """Gets the take_profit_on_fill of this LimitOrderRequest.  # noqa: E501


        :return: The take_profit_on_fill of this LimitOrderRequest.  # noqa: E501
    ...
    def take_profit_on_fill(self, take_profit_on_fill):
        """Sets the take_profit_on_fill of this LimitOrderRequest.


        :param take_profit_on_fill: The take_profit_on_fill of this LimitOrderRequest.  # noqa: E501
    ...
    def stop_loss_on_fill(self):
        """Gets the stop_loss_on_fill of this LimitOrderRequest.  # noqa: E501


        :return: The stop_loss_on_fill of this LimitOrderRequest.  # noqa: E501
    ...
    def stop_loss_on_fill(self, stop_loss_on_fill):
        """Sets the stop_loss_on_fill of this LimitOrderRequest.


        :param stop_loss_on_fill: The stop_loss_on_fill of this LimitOrderRequest.  # noqa: E501
    ...
    def trailing_stop_loss_on_fill(self):
        """Gets the trailing_stop_loss_on_fill of this LimitOrderRequest.  # noqa: E501


        :return: The trailing_stop_loss_on_fill of this LimitOrderRequest.  # noqa: E501
    ...
    def trailing_stop_loss_on_fill(self, trailing_stop_loss_on_fill):
        """Sets the trailing_stop_loss_on_fill of this LimitOrderRequest.


        :param trailing_stop_loss_on_fill: The trailing_stop_loss_on_fill of this LimitOrderRequest.  # noqa: E501
    ...
    def trade_client_extensions(self):
        """Gets the trade_client_extensions of this LimitOrderRequest.  # noqa: E501


        :return: The trade_client_extensions of this LimitOrderRequest.  # noqa: E501
        :rtype: ClientExtensions
        """
    ...
    def trade_client_extensions(self, trade_client_extensions):
        """Sets the trade_client_extensions of this LimitOrderRequest.


        :param trade_client_extensions: The trade_client_extensions of this LimitOrderRequest.  # noqa: E501
        :type: ClientExtensions
        """
