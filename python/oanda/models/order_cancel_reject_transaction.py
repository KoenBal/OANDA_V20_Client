...
class OrderCancelRejectTransaction(object):
    ...
    def __init__(self, id=None, time=None, user_id=None, account_id=None, batch_id=None, request_id=None, type=None, order_id=None, client_order_id=None, reject_reason=None):  # noqa: E501
        """OrderCancelRejectTransaction - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this OrderCancelRejectTransaction.  # noqa: E501

        The Transaction's Identifier.  # noqa: E501

        :return: The id of this OrderCancelRejectTransaction.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this OrderCancelRejectTransaction.

        The Transaction's Identifier.  # noqa: E501

        :param id: The id of this OrderCancelRejectTransaction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time(self):
        """Gets the time of this OrderCancelRejectTransaction.  # noqa: E501

        The date/time when the Transaction was created.  # noqa: E501

        :return: The time of this OrderCancelRejectTransaction.  # noqa: E501
        :rtype: str
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this OrderCancelRejectTransaction.

        The date/time when the Transaction was created.  # noqa: E501

        :param time: The time of this OrderCancelRejectTransaction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_id(self):
        """Gets the user_id of this OrderCancelRejectTransaction.  # noqa: E501

        The ID of the user that initiated the creation of the Transaction.  # noqa: E501

        :return: The user_id of this OrderCancelRejectTransaction.  # noqa: E501
        :rtype: int
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this OrderCancelRejectTransaction.

        The ID of the user that initiated the creation of the Transaction.  # noqa: E501

        :param user_id: The user_id of this OrderCancelRejectTransaction.  # noqa: E501
        :type: int
        """
    ...
    @property
    def account_id(self):
        """Gets the account_id of this OrderCancelRejectTransaction.  # noqa: E501

        The ID of the Account the Transaction was created for.  # noqa: E501

        :return: The account_id of this OrderCancelRejectTransaction.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this OrderCancelRejectTransaction.

        The ID of the Account the Transaction was created for.  # noqa: E501

        :param account_id: The account_id of this OrderCancelRejectTransaction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def batch_id(self):
        """Gets the batch_id of this OrderCancelRejectTransaction.  # noqa: E501
        ...
        :return: The batch_id of this OrderCancelRejectTransaction.  # noqa: E501
        :rtype: str
        """
    ...
    def batch_id(self, batch_id):
        """Sets the batch_id of this OrderCancelRejectTransaction.

        The ID of the \"batch\" that the Transaction belongs to. Transactions in the same batch are applied to the Account simultaneously.  # noqa: E501

        :param batch_id: The batch_id of this OrderCancelRejectTransaction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def request_id(self):
        """Gets the request_id of this OrderCancelRejectTransaction.  # noqa: E501

        The Request ID of the request which generated the transaction.  # noqa: E501

        :return: The request_id of this OrderCancelRejectTransaction.  # noqa: E501
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        """Sets the request_id of this OrderCancelRejectTransaction.

        The Request ID of the request which generated the transaction.  # noqa: E501

        :param request_id: The request_id of this OrderCancelRejectTransaction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this OrderCancelRejectTransaction.  # noqa: E501

        The Type of the Transaction. Always set to \"ORDER_CANCEL_REJECT\" for an OrderCancelRejectTransaction.  # noqa: E501

        :return: The type of this OrderCancelRejectTransaction.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this OrderCancelRejectTransaction.

        The Type of the Transaction. Always set to \"ORDER_CANCEL_REJECT\" for an OrderCancelRejectTransaction.  # noqa: E501

        :param type: The type of this OrderCancelRejectTransaction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def order_id(self):
        """Gets the order_id of this OrderCancelRejectTransaction.  # noqa: E501

        The ID of the Order intended to be cancelled  # noqa: E501

        :return: The order_id of this OrderCancelRejectTransaction.  # noqa: E501
        :rtype: str
        """
    ...
    def order_id(self, order_id):
        """Sets the order_id of this OrderCancelRejectTransaction.

        The ID of the Order intended to be cancelled  # noqa: E501

        :param order_id: The order_id of this OrderCancelRejectTransaction.  # noqa: E501
        :type: str
        """
    ...
    def client_order_id(self):
        """Gets the client_order_id of this OrderCancelRejectTransaction.  # noqa: E501

        The client ID of the Order intended to be cancelled (only provided if the Order has a client Order ID).  # noqa: E501

        :return: The client_order_id of this OrderCancelRejectTransaction.  # noqa: E501
        :rtype: str
        """
    ...
    def client_order_id(self, client_order_id):
        """Sets the client_order_id of this OrderCancelRejectTransaction.

        The client ID of the Order intended to be cancelled (only provided if the Order has a client Order ID).  # noqa: E501

        :param client_order_id: The client_order_id of this OrderCancelRejectTransaction.  # noqa: E501
        :type: str
        """
    ...
    def reject_reason(self):
        """Gets the reject_reason of this OrderCancelRejectTransaction.  # noqa: E501

        The reason that the Reject Transaction was created  # noqa: E501

        :return: The reject_reason of this OrderCancelRejectTransaction.  # noqa: E501
        :rtype: str
        """
    ...
    def reject_reason(self, reject_reason):
        """Sets the reject_reason of this OrderCancelRejectTransaction.

        The reason that the Reject Transaction was created  # noqa: E501

        :param reject_reason: The reject_reason of this OrderCancelRejectTransaction.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrderCancelRejectTransaction):
            return False
